...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({
      ...prev,
      equipmentQty: Math.min(
        Math.max(prev.equipmentQty || 1, 1),
        selectedEquipment.qty
      ),
    }));
  }, [selectedEquipment]);
            ...
            >
              <div className="mb-10">
                ...
                <p className="text-gray-500 font-medium text-sm">
                  Fill out the form below to connect with our project management
                  or tender division.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  >
                    ...
                    <option value="New Project/Tender">
                      New Project / Tender Proposal
                    </option>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto bg-[#f25810] hover:bg-[#d44a0d] text-white px-10 py-4 font-black uppercase tracking-widest text-sm transition-all flex items-center justify-center disabled:opacity-70 group"
                >
                  {loading ? (
                    <>
            ...
            >
              <div className="bg-white p-8 border border-gray-200 mb-8 border-l-4 border-l-[#f25810]">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-4">
                  For equipment leasing, raw material supply, and subcontractor
                  registration, please ensure you select "Vendor / Supplier
                  Registration" in the inquiry form to be routed to our
                  procurement division.
                </p>
                <a
                  href="#"
                  className="text-[#f25810] text-sm font-bold uppercase tracking-widest hover:text-gray-900 transition-colors"
                >
                  Download Vendor Form →
                </a>
              </div>

              {/* Map Container - FIXED REACT JSX WARNINGS HERE */}
              <div className="flex-1 bg-gray-300 min-h-75 border border-gray-200 relative group overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31433.806629653067!2d72.92075740033292!3d22.558570121744133!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e4e84b2569f97%3A0x882ca4231a5bd1fb!2sMB%20Infraprojects%20Pvt.%20Ltd.!5e1!3m2!1sen!2sin!4v1779717794851!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  className="absolute inset-0 group-hover:filter-none transition-all duration-700 min-h-75"
                ></iframe>
              </div>
            </motion.div>
          </div>
